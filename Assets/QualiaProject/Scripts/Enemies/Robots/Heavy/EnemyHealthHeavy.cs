...
{
    public class EnemyHealthHeavy : MonoBehaviour
    {
        ...
        EnemyMovementHeavy enemyMovementHeavy;
        ...
        void Awake()
        {
            ...
            enemyMovementHeavy = GetComponent<EnemyMovementHeavy>();
        ...
        public void TakeDamage(int amount, Vector3 hitPoint)
        {
            ...
            //Debug.Log("Heavy    health ------ " + currentHealth);
            ...
            //5% chance to stun enemy while attacking the player
            if (Random.Range(1, 21) == 1)
            {
                enemyMovementHeavy.TriggerStunAnimation();
            }
