...
{
    public class EnemyHealthAssault : MonoBehaviour
    {
        ...
        EnemyMovementAssault enemyMovementAssault;
        ...
        void Awake()
        {
            ...
            enemyMovementAssault = GetComponent<EnemyMovementAssault>();
        ...
        public void TakeDamage(int amount, Vector3 hitPoint)
        {
            ...
            //Debug.Log("Assault    health ------ " + currentHealth);
            ...
            //10% chance to stun enemy while running
            //if (Random.Range(1, 11) == 1)
            //{
            //    anim.SetTrigger("Damage");
            //    enemyMovementAssault.PauseMesh();
            //}

            //50% chance to stun enemy while attacking the player
            if (Random.Range(1, 3) == 1)
                enemyAttackAssault.ResetTimer();

            //If enemy hasn't reached player yet, resume walking animation
            if (!enemyAttackAssault.playerInRange)
