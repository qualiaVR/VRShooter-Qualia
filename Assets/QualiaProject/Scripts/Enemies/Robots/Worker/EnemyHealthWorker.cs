...
{
    public class EnemyHealthWorker : MonoBehaviour
    {
        ...
        EnemyMovementWorker enemyMovementWorker;
        ...
        void Awake()
        {
            ...
            enemyMovementWorker = GetComponent<EnemyMovementWorker>();
        ...
        public void TakeDamage(int amount, Vector3 hitPoint)
        {
            ...
            //Debug.Log("Worker    health ------ " + currentHealth);
